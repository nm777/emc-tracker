...
1. Download the app files (if you received a zip file, unzip it)
2. Remember where you saved it — for example, your Desktop or Documents folder
...
| `cities.json` | Project configuration (name, city, coordinates, start date) |
| `humidity_log.csv` | Daily EMC summaries (min, max, avg, swing) |
